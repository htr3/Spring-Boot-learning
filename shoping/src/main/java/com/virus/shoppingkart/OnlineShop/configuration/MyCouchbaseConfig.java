package com.virus.shoppingkart.OnlineShop.configuration;
...
@Configuration
@EnableCouchbaseRepositories(basePackages = { "com.virus.shoppingkart.OnlineShop" })
public class MyCouchbaseConfig extends AbstractCouchbaseConfiguration {

    public static final String NODE_LIST = "localhost";
    public static final String BUCKET_NAME = "OnlineShoping";
